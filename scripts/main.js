...
UnitTypes.mace.armor = 6;

//fortress
UnitTypes.fortress.speed = 0.52;
UnitTypes.scepter.weapons.get(0).bullet.lifetime = 29;
UnitTypes.scepter.weapons.get(1).bullet.lifetime = 45;
...
UnitTypes.corvus.weapons.get(0).shoot.shots = 6;
...
UnitTypes.arkyid.weapons.get(6).bullet.splashDamage = 75;
...
UnitTypes.toxopid.weapons.get(3).bullet.damage = 130;
UnitTypes.toxopid.weapons.get(0).bullet.damage = 170;
UnitTypes.toxopid.weapons.get(1).bullet.damage = 170;
...
UnitTypes.eclipse.speed = 0.77;
UnitTypes.eclipse.armor = 19;
